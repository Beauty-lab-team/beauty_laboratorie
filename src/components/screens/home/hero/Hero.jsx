               ...
               <Section>
                  <div className={s.hero}>
                     <div className={s.insta}>
                        ...
                        <InstagramEmbed url='https://www.instagram.com/reel/C2xXTnmiV-r/' width={isDesktop ? '340px' : '100%'} />
                     </div>
                     <div className={`${s.info} ${s.giftCard}`}>
                        ...
                        <Link rel='nofollow' href='https://www.instagram.com/reel/C2xXTnmiV-r/'>
                           <Button secondary='true'>Дізнатися більше</Button>
                        </Link>
                     </div>
                  </div>
               </Section>
