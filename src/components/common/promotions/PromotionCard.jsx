...
export default function PromotionCard({ title, coverImage, slug, content, publishedAt }) {
   ...
   return (
      <div className={s.promotion}>
         ...
         <div className={s.buttons}>
            <LinkToPage className='col-span-2' link={`/actual/promotions/${capitalizeSlug(slug)}`}>
               Читати
            </LinkToPage>
         </div>
      </div>
